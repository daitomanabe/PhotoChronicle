...
struct ContentView: View {
    ...
    @State private var currentStep: WorkflowStep = .database
    ...
    enum WorkflowStep: Int, CaseIterable, Identifiable {
        ...
        var title: String {
            switch self {
            case .database: return "1. Database"
            case .sources: return "2. Sources"
            case .destination: return "3. Destination"
            case .phase1: return "4. Analysis"
            case .phase2: return "5. Execution"
            }
        }
        ...
        var icon: String {
            ...
            case .sources: return "arrow.down.doc"
            case .destination: return "externaldrive"
            case .phase1: return "magnifyingglass"
            case .phase2: return "play.fill"
            }
        }
    }
        ...
        VStack(spacing: 0) {
            ...
            ZStack {
                ...
                Group {
                    switch currentStep {
                    case .database:
                        StepCard(title: "Step 1: Plan Database", icon: "database") {
                            planDatabaseSection
                        }
                    case .sources:
                        StepCard(title: "Step 2: Input Sources", icon: "arrow.down.doc") {
                            sourcesSection
                        }
                    case .destination:
                        StepCard(title: "Step 3: Destination", icon: "externaldrive") {
                            destinationSection
                        }
                    case .phase1:
                        StepCard(title: "Step 4: Analysis (Phase 1)", icon: "magnifyingglass") {
                            phase1Section
                        }
                    case .phase2:
                        StepCard(title: "Step 5: Execution (Phase 2)", icon: "play.fill") {
                            phase2Section
                        }
                    }
                }
